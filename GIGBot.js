/**
*Copyright 2014 Mathieu Samaey (original creator) 
*Modifications (including forks) of the code to fit personal needs are allowed only for personal use and should refer back to the original source.
*This software is not for profit, any extension, or unauthorised person providing this software is not authorised to be in a position of any monetary gain from this use of this software. Any and all money gained under the use of the software (which includes donations) must be passed on to the original author.
*This JS is modified by Sataday for GoodIdeaGaming's plug.dj only. Original JS link: https://raw.githubusercontent.com/Yemasthui/basicBot/master/basicBot.js
*/
        ...
        chatUtilities: {        
            ...
            commandCheck: function(chat){
                ...
                switch(cmd){
                    ...
                    case '!twitter':            esBot.commands.twitCommand.functionality(chat, '!twitter');                         executed = true; break;
                    ...
                    case '!kills':              esBot.commands.killCommand.functionality(chat, '!kills');                            executed = true; break;
                ...
                twitCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.twitLink === "string")
                                        API.sendChat('/me [' + chat.from + '] Follow GIG on Twitter: ' + esBot.roomSettings.twitLink);
                                };                              
                        },
                },
